...
REAL _rho = 0.05f;
float _kappa[2][4] = {
	/* nZ=0 */ {0.14f, 0.14f, 0.12f, 0.12f},
	/* nZ=1 */ {0.16f, 0.13f, 0.11f, 0.11f}
};
float _beta[2][4] = {
	/* nZ=0 */ {5.70f, 3.40f, 2.20f, 2.05f},
	/* nZ=1 */ {5.10f, 3.00f, 2.00f, 1.90f}
};
float _mu[2][4] = {
	/* nZ=0 */ {0.000f, 0.003f, 0.003f, 0.002f},
	/* nZ=1 */ {0.003f, 0.003f, 0.002f, 0.002f}
};
